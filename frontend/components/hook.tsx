...
export default function Hook() {
    return (
        <div className={styles.hook}>
            ...
            <svg viewBox="0 0 347 165" fill="none" className={["circle", styles.hook_svg].join(' ')} xmlns="http://www.w3.org/2000/svg">
            ...
            <svg viewBox="0 0 342 47" fill="none" className={["squiggle", styles.hook_svg].join(' ')} xmlns="http://www.w3.org/2000/svg">
