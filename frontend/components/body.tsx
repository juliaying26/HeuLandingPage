...
export default function Body() {
    return (
        <div className={styles.body}>
            ...
            <p id="fn2" className={styles.footnote_link}>2. <a href="https://pubs.aeaweb.org/doi/pdfplus/10.1257/pol.20210336" target="_blank" className={styles.footnote_link}>Heller and Mumma, <i>Immigrant Integration in the United States: The Role of Adult English Language Training</i>, 2023.</a></p>
            <p id="fn3" className={styles.footnote_link}>3. <a href="https://nces.ed.gov/programs/digest/d22/tables/dt22_507.20.asp?current=yes" target="_blank" className={styles.footnote_link}>National Center for Education Statistics, <i>Participants in State-Administered Adult Basic Education, Adult Secondary Education, and English Language Acquisition Programs</i>, 2022.</a></p>
        </div>
    );
}